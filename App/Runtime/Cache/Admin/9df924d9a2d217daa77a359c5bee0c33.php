                ...
                <table class="table table-hover">
					<thead>
						<tr>
							...
							<th>IP</th>
							<th class="col-xs-4">日志内容</th>
							<th class="center">删除记录</th>
						</tr>
					</thead>
					<tbody>
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
							...
							<td><a class="del" href="javascript:;" val="<?php echo U('del');?>?id=<?php echo ($val['id']); ?>" title="删除"><i class="fa fa-trash-o"></i></a><td>
						</tr><?php endforeach; endif; else: echo "" ;endif; ?>
						<tr>
							<td>1</td>
							<td>admin</td>
							<td>2016-4-22 11:23</td>
							<td>0.0.0.0</td>
							<td>登录访问</td>
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-success">
                ...
                <div class="box-body chat" id="chat-box">
                  <!-- chat item -->
                  <div class="item">
                    <img src="/AdminLTE/Public/images/user4-128x128.jpg" alt="user image" class="online">
                    <p class="message">
                      <a href="#" class="name">
                  ...
                  <!-- chat item -->
                  <div class="item">
                    <img src="/AdminLTE/Public/images/user3-128x128.jpg" alt="user image" class="offline">
                    <p class="message">
                      <a href="#" class="name">
                  ...
                  <!-- chat item -->
                  <div class="item">
                    <img src="/AdminLTE/Public/images/user2-160x160.jpg" alt="user image" class="offline">
                    <p class="message">
                      <a href="#" class="name">
