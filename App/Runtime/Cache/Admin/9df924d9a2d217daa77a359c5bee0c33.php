...
<html>
  <head>
    ...
    <!-- Bootstrap 3.3.5 -->
    <link rel="stylesheet" href="/TonyMB/Bootstrap/css/bootstrap.min.css">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="/TonyMB/Plugins/fa/css/font-awesome.min.css">
    <!-- Theme style -->
    <link rel="stylesheet" href="/TonyMB/Public/css/AdminLTE.min.css">
    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="/TonyMB/Public/css/skins.min.css">
  </head>
  <body class="hold-transition skin-blue sidebar-mini">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="/TonyMB/Public/upload/image/<?php echo ($_SESSION['href']); ?>" class="user-image" alt="User Image">
                  <span class="hidden-xs"><?php echo ($_SESSION['account']); ?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="/TonyMB/Public/upload/image/<?php echo ($_SESSION['href']); ?>" class="img-circle" alt="User Image">
                    <p>
	...
	<aside class="main-sidebar">
      ...
      <div class="content-wrapper">
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-success">
                ...
                <div class="box-body chat" id="chat-box">
                  <!-- chat item -->
                  <div class="item">
                    <img src="/TonyMB/Public/images/user4-128x128.jpg" alt="user image" class="online">
                    <p class="message">
                      <a href="#" class="name">
                  ...
                  <!-- chat item -->
                  <div class="item">
                    <img src="/TonyMB/Public/images/user3-128x128.jpg" alt="user image" class="offline">
                    <p class="message">
                      <a href="#" class="name">
                  ...
                  <!-- chat item -->
                  <div class="item">
                    <img src="/TonyMB/Public/images/user2-160x160.jpg" alt="user image" class="offline">
                    <p class="message">
                      <a href="#" class="name">
		...
		<!-- jQuery 1.1.12 -->
    <script src="/TonyMB/Public/js/jquery.js"></script>
	<!-- layer 2.2 -->
	<script src="/TonyMB/Plugins/layer/layer.js"></script>
    <!-- Bootstrap 3.3.5 -->
    <script src="/TonyMB/Bootstrap/js/bootstrap.min.js"></script>
    <!-- AdminLTE App -->
    <script src="/TonyMB/Public/js/app.min.js"></script>
  </body>
</html>