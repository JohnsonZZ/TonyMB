                        ...
                        <form role="form" action="<?php echo U('update');?>" method="post">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="account" id="account" placeholder="输入账号" value="<?php echo ($list['account']); ?>" />
                                </div>
								<div class="form-group">
                                    <label for="nick">
                                        昵称
                                    </label>
                                    <input type="text" class="form-control" name="nick" id="nick" placeholder="输入昵称" value="<?php echo ($list['nick']); ?>" />
                                </div>
                                <div class="form-group">
                                    <label for="pwd">
                                        密码
                                    </label>
                                    <input type="password" class="form-control" name="pwd" id="pwd" placeholder="输入新密码" />
                                </div>
								<div class="form-group">
                                    <label for="email">
                                        邮箱
                                    </label>
                                    <input type="email" class="form-control" name="email" id="email" placeholder="输入邮箱" value="<?php echo ($list['email']); ?>" />
                                </div>
								<div class="form-group">
                                    <label for="phone">
                                        电话
                                    </label>
                                    <input type="text" class="form-control" name="phone" id="phone" placeholder="输入电话" value="<?php echo ($list['phone']); ?>" />
                                </div>
