                  ...
                  <li>
                    ...
                    <ul class="menu">
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="/AdminLTE/Public/images/user3-128x128.jpg" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="/AdminLTE/Public/images/user4-128x128.jpg" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                            Developers
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo U('User/index');?>"><i class="fa fa-circle-o"></i> 查看用户</a></li>
                <li><a href="<?php echo U('User/add');?>"><i class="fa fa-circle-o"></i> 添加用户</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo U('List/index');?>"><i class="fa fa-circle-o"></i> 查看列表</a></li>
                <li><a href="<?php echo U('List/add');?>"><i class="fa fa-circle-o"></i> 添加列表</a></li>
              </ul>
            </li>
            ...
            <li><a href="#"><i class="fa fa-circle-o text-aqua"></i> <span>一般信息</span></a></li>
          </ul>
        </section>
        <!-- /.sidebar -->
      </aside>
